<template>
 ...
 <mt-swipe :auto="4000">
   ...
   <mt-swipe-item>
     <img src="../assets/images/小龙虾.jpg" alt=""/>   
   </mt-swipe-item>
   <mt-swipe-item>
     <img src="../assets/images/小炒牛肉.jpg" alt=""/>
   </mt-swipe-item>
   <mt-swipe-item>
     <img src="../assets/images/满杯百香果.jpg" alt=""/>
   </mt-swipe-item>
 </mt-swipe>
    ...
    <ul class="mui-table-view">
      <li v-for="item in noticesList" :key="item.noticeId" class="mui-table-view-cell">
        <router-link  :to="'/notice/'+item.noticeId">{{item.noticeTitle}}</router-link>
      </li>
    </ul>
  </div>
</template>
...
export default {
  ...
  methods:{
    getLunbotu(){
      //获取News的ajax请求
      this.axios.get("/notice/allNotice").then(result=>{
        console.log(result);
        this.noticesList=result.data.data;
       })
    }
  }
}
