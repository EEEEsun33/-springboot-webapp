...
<#--                                <td><img height="100" width="100" src="images/芝士绿妍.jpg" alt=""></td>-->
                                <td><img height="100" width="100" src="images/${productInfo.productIcon}" alt=""></td>
...
<#--                                <td>${productInfo.updateTime}</td>-->
                                ...
                                <td>
                                    <a href="/sell/seller/product/delete?productId=${productInfo.productId}" onclick="return confirm('你确定要删除该商品吗？')">删除</a>
                                </td>
                                <td>
